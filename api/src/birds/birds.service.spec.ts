...
describe('BirdsService', () => {
  ...
  beforeEach(async () => {
        ...
        providers: [
          BirdsService,
          {
            ...
            useValue: {
              save: jest
                .fn()
                .mockResolvedValue(createBird()), //maak een mock functie --> je wil de functie save niet testen van "typeorm"
              find: jest
                .fn()
    ...
    mockBirdRepository = module.get<Repository<Bird>>(
      getRepositoryToken(Bird),
    )
  })
    ...
    describe('when findOne is called', () => {
      ...
      it('should be called with the correct params', async () => {
        ...
        expect(findSpy).toBeCalledWith(
          new ObjectId('d89a0bA4cc619d347024f42e'),
        )
      })
